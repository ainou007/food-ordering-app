...
// When the link is hovered over, it sets prefetching to true, which triggers Next.js to prefetch the page's content in the background, improving performance and user experience.
