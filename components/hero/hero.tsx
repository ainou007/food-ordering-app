    ...
    <section className="section-padding flex items-center text-center lg:h-[calc(100vh-72px)] lg:text-start">
      <div className="container grid grid-cols-12 items-center">
        <div className="col-span-full space-y-5 lg:col-span-8">
          <h1 className={cn("mb-10 text-7xl font-bold uppercase leading-none text-primary drop-shadow-lg lg:mb-0", dancingScript.className)}>
            {home_page("title")}
          </h1>
        ...
        <div className="relative col-span-full hidden h-72 lg:col-span-4 lg:block">
