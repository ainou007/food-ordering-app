    ...
    <section className="section-padding flex items-center text-center lg:h-[calc(100vh-72px)] lg:text-start">
      <div className="container grid grid-cols-12 items-center">
        <div className="col-span-full space-y-5 lg:col-span-8">
          <h1 className={cn("mb-10 text-4xl font-bold uppercase leading-snug text-primary drop-shadow-lg lg:mb-0 lg:text-7xl", dancingScript.className)}>{t("HomePage.title")}</h1>
          <div className="relative flex h-56 justify-center lg:hidden">
            <Image src="/tajin.png" alt="" width={3000} height={200} loading="eager" priority className="object-contain" />
          </div>
        ...
        <div className="relative col-span-4 hidden h-[500px] items-center justify-center lg:flex">
          <Image src="/tajin.png" alt="" width={240} height={200} loading="eager" priority className="object-contain" />
        </div>
      </div>
    </section>
  );
